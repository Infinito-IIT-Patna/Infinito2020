    ...
    <div class="main-page-wrapper">
          ...
          >
            <ul>
              ...
              >
                ...
                <div class="tp-caption">
                  <a
                    ...
                    class="project-button hvr-bounce-to-right"
                    >Register Here</a
                  >
                </div>
              </li>
              ...
              <li
                ...
                data-easeout="default"
                data-masterspeed="default"
                data-thumb="video/drinkwinecover.jpg"
                data-rotate="0"
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
              <div class="single-events-content">
                ...
                <div class="tp-caption">
                  <a
                    id="modal-btn--3"
                    class="modal-btn project-button hvr-bounce-to-right button"
                    >See More</a
                  >
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
              <div class="single-events-content">
                <div class="icon-heading tran3s">
                  <div class="icon tran3s">
                    <img
                      src="images/fav-icon/icons8-cricket-filled-96.png"
                      alt=""
                    />
                  </div>
      ...
      <footer>
        <div class="container">
          ...
          <ul>
            <li>
              <a href="#" target="_blank" class="tran3s round-border"
