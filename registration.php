    ...
    <div class="container">
        <div id="register" style="min-height:100vh">
            ...
            <div class="col registerButton" style="margin-top:3%;" >
                ...
                <div class="col-lg-3 col-md-6 col-sm-10 col-xs-10" style="width:200px;">
                    <a class="tp-caption">
                        <a href="./registerTeam.php" class="score-btn project-button hvr-bounce-to-right" style="padding:10px 15px;font-size:16px;border: #d8545d 2px solid;width:100%; text-align:center;">Team Registration</a>
                    </a>
                </div>
